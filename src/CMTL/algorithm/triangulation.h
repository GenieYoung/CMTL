...
//         /**
//          * @brief return a vertex w such that uvw is a positively oriented
//          triangle
//          */
//         int adjacent(int u, int v);

//         /**
//          * @brief return vertices v, w such that uvw is a positively oriented
//          triangle
//          */
...
//         _adjacent_face_table;

//         /* used for adjacent2vertex method, given an i'th vertex, return a
//         vertex in a same triangle */ std::vector<int> _adjacent_edge_table;
// };
...
// // bool TriangulationStorage::Triangle::operator<(const Triangle& other)
// const
// // {
// //     return (vids[0] < other.vids[0]) || (vids[0] == other.vids[0] &&
// vids[1] < other.vids[1]);
// // }
...
//     /* following operation may be redundant, if make sure every triangle
//     deletion
...
//     if(_triangles.empty())
//     {
//         ORIENTATION ori = orient_2d(_vertices[0].pos, _vertices[1].pos,
//         v.pos); if(ori == ORIENTATION::COLLINEAR)   // still all collinear,
//         just insert the vertex
//             return _vertices.size() - 1;
