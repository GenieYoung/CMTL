#ifndef CMTL_GEO2D_SURFACE_MESH_H
#define CMTL_GEO2D_SURFACE_MESH_H
...
class SurfaceMesh : public halfedge::Graph<geo2d::Point<T>, Traits> {
 ...
 public:
  ...
  /**
   * @brief split an edge on point p, split the adjacent faces when split_face
   * is true
...
#endif  // CMTL_GEO2D_SURFACE_MESH_H