#include "CMTL/geometry/geo3d/geo3d_plane.h"

void test1()
{
    CMTL::geometry::geo3d::Plane<double> plane(CMTL::geometry::geo3d::Point<double>(0, 0, 0), CMTL::geometry::geo3d::Point<double>(1, 0, 0));
    CMTL::geometry::geo3d::Point<double> p(0, 3, 3);
    ...
    CMTL::geometry::geo3d::Plane<double> plane2(CMTL::geometry::geo3d::Point<double>(0, 0, 0), CMTL::geometry::geo3d::Point<double>(1, 1, 1));
    CMTL::geometry::geo3d::Point<double> p2(2, -1, -1);
