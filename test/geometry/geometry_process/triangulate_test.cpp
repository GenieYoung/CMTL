...
void test2()
{
    ...
    points.push_back(CMTL::geometry::geo2d::Point<double>{0,0});
    points.push_back(CMTL::geometry::geo2d::Point<double>{1,0});
    points.push_back(CMTL::geometry::geo2d::Point<double>{2,0});
    points.push_back(CMTL::geometry::geo2d::Point<double>{0,1});
    CMTL::geometry::geo2d::Polygon<double> polygon(points);
    std::vector<std::array<unsigned int, 3>> clip_triangles;
    CMTL::geometry::geometry_process::triangulate_2d(polygon, clip_triangles);
...
void test3()
{
    ...
    points.push_back(CMTL::geometry::geo2d::Point<double>{0,1});
    std::vector<std::array<unsigned int, 3>> clip_triangles;
    CMTL::geometry::geometry_process::triangulate_2d(points, clip_triangles);
...
void test4()
{
    ...
    CMTL::geometry::geo3d::Polygon<double> polygon(points);
    std::vector<std::array<unsigned int, 3>> clip_triangles;
    CMTL::geometry::geometry_process::triangulate_3d(polygon, clip_triangles);
