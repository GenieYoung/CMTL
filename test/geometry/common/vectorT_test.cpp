...
typedef CMTL::geometry::VectorT<double, 1> Vec1d;
typedef CMTL::geometry::VectorT<float, 1>  Vec1f;

typedef CMTL::geometry::VectorT<double, 2> Vec2d;
typedef CMTL::geometry::VectorT<float, 2>  Vec2f;
