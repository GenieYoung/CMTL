...
#include "CMTL/geometry_algorithm/triangulate_polygon.h"
...
void test1()
{
    ...
    CMTL::geometry_algorithm::triangulate_polygon_2d(polygon, clip_triangles);
...
void test3()
{
    ...
    points.push_back(CMTL::geo2d::Point<double>{0,1});
    std::vector<std::array<unsigned int, 3>> clip_triangles;
    CMTL::geometry_algorithm::triangulate_polygon_2d(points, clip_triangles);
...
void test4()
{
    ...
    std::vector<std::array<unsigned int, 3>> clip_triangles;
    CMTL::geometry_algorithm::triangulate_polygon_3d(polygon, clip_triangles);
...
void test5()
{
    ...
    points.push_back(CMTL::geo3d::Point<double>{0,1,0});
    std::vector<std::array<unsigned int, 3>> clip_triangles;
    CMTL::geometry_algorithm::triangulate_polygon_3d<double>(points, clip_triangles);
