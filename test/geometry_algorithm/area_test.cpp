...
#include "CMTL/geometry_algorithm/area.h"
...
void test1()
{
    ...
    std::cout << "area : " << CMTL::geometry_algorithm::area(polygon) << std::endl;
    double area1;
    CMTL::geometry_algorithm::area_2d(points.begin(), points.end(), area1);
    std::cout << "area1 : " << area1 << std::endl;
    double area2;
    CMTL::geometry_algorithm::area_2d(points, area2);
