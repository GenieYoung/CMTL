...
using CMTL::algorithm::extrude_surface;
...
void test1() {
  ...
  // vertices.push_back(sm.add_vertex(Point(1,-1,0)));
  sm.add_face(std::vector<SurfaceMesh::VertexHandle>{vertices[0], vertices[1],
                                                     vertices[2]});
  sm.add_face(std::vector<SurfaceMesh::VertexHandle>{vertices[0], vertices[2],
                                                     vertices[3]});
  sm.add_face(std::vector<SurfaceMesh::VertexHandle>{vertices[0], vertices[3],
                                                     vertices[4]});
  sm.add_face(std::vector<SurfaceMesh::VertexHandle>{vertices[0], vertices[4],
                                                     vertices[5]});
  // sm.add_face(std::vector<SurfaceMesh::VertexHandle>{vertices[0],
  // vertices[5], vertices[6], vertices[7]});
  // sm.add_face(std::vector<SurfaceMesh::VertexHandle>{vertices[0],
  // vertices[7], vertices[8], vertices[1]});
